function handleGenerateSectionProductPage(is, ip) {
  try {
    window.open().document.write(
      ...
      <body>
        ...
        <script src="./js/data-changer.js"></script>
        <script>
          changeDataFromPage(sections[${is}].products[${ip}])
        </script>
      </body>
      
      </html>`
    ) // stopped here, it's very close to the page be generated with the data
  } catch {
